...
<style>
/* ══════════════════════════════════════════════════════════════════
   LIMS PREMIUM DESIGN SYSTEM v2  ·  2-Color Brand System (IPD)
...
/* Orders List — cream (#F3EFE6) background */
...
/* Body rows — cream background, hover = white */
...
.lo-filter-top{background:var(--s-lt)}
.lo-chip.active i{color:var(--s)!important}
.lo-skel-row{background:var(--s)}
</style>
