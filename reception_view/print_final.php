...
function renderBill(b) {
    ...
    const dischargedBed = bedParts.length ? bedParts.join(' / ') : (b.room_no ? `Room ${b.room_no}` : '—');
    ...
    document.getElementById('metaDetails').innerHTML = `
        <div>
            ...
            <div class="meta-row"><div class="meta-label">Discharged Bed</div><div class="meta-val">: ${dischargedBed}</div></div>
